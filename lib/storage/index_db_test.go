...
func TestIndexDB(t *testing.T) {
	...
	t.Run("serial", func(t *testing.T) {
		...
		s := MustOpenStorage(path, StorageOptions{Retention: retentionMax})
...
func TestIndexDBRepopulateAfterRotation(t *testing.T) {
	...
	s := MustOpenStorage(path, StorageOptions{Retention: retention31Days, MaxDailySeries: 1e5, MaxHourlySeries: 1e5})
